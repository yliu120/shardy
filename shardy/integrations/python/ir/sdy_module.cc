  ...
  mlir::python::nanobind_adaptors::mlir_attribute_subclass(
      ...
      .def_classmethod(
          ...
          [](nb::object cls, const std::vector<int64_t>& factorSizes,
             ...
             const std::vector<int64_t>& sizeMismatchFactors, bool isCustom,
             MlirContext ctx) {
            return cls(sdyOpShardingRuleAttrGet(
                ...
                sizeMismatchFactors.size(), sizeMismatchFactors.data(),
                isCustom));
          },
          ...
          nb::arg("size_mismatch_factors") = std::vector<int64_t>(),
      ...
      .def_property_readonly("size_mismatch_factors", [](MlirAttribute self) {
        return propertyVector<intptr_t>(
            self, sdyOpShardingRuleAttrGetSizeMismatchFactorsSize,
            sdyOpShardingRuleAttrGetSizeMismatchFactorsElem);
      });

...
MlirAttribute sdyOpShardingRuleAttrGet(
  ...
  return wrap(sdy::OpShardingRuleAttr::get(
      ...
      mlir::ArrayRef(sizeMismatchFactors, nSizeMismatchFactors), isCustomRule));
}
...
intptr_t sdyOpShardingRuleAttrGetSizeMismatchFactorsSize(MlirAttribute attr) {
  return unwrapAttr<sdy::OpShardingRuleAttr>(attr)
      .getSizeMismatchFactors()
      .size();
}

int64_t sdyOpShardingRuleAttrGetSizeMismatchFactorsElem(MlirAttribute attr,
                                                        intptr_t pos) {
  return unwrapAttr<sdy::OpShardingRuleAttr>(attr)
      .getSizeMismatchFactors()[pos];
}
